import imageSup from './superman.jpg'

export default function HeroesReducers () {
    return [
        {
           nickName : 'superman',
           realName : 'Clark Kent',
           originDescription : 'he was born Kal-El on the planet Krypton, before being rocketed to \
        ...
        },
        {
            ...
            image : 'https://avatars.mds.yandex.net/get-zen_doc/\
            1578824/pub_5d1b146f60d75900ad954f32_5d1b14a6e3841c00b07044bf/scale_1200'
        },
        {
            ...
            image : 'https://i0.wp.com/bamfstyle.com/wp-content/uploads/2020/10/JBourne-MAIN1.jpg?ssl=1'
        },
        {
            nickName : 'terminator',
            ...
            image : 'https://www.film.ru/sites/default/files/filefield_paths/terminator_0.jpg'
        }
    ]
}